...
### Frontend & Deployment
| Keahlian | Alat & Platform |
| --- | --- |
| **Bahasa & Framework** | HTML5, CSS3, JavaScript (ES6+) |
| **Desain & UI** | Figma, Tailwind CSS |
| **Deployment & Cloud** | Vercel, Netlify, GitHub Pages |

### Tools & AI Workflow
*   **Editor:** VS Code (with GitHub Copilot)
*   **AI & Model Dev:** Hugging Face, Claude, Gemini AI
...
## 🌌 Estetika & Inspirasi
Selain coding, saya sangat menikmati perpaduan antara kontras modern dan sejarah. Inspirasi visual saya bergerak di antara:
*   **Modern Urban:** Suasana gemerlap lampu malam di Shibuya Crossing.
*   **Klasik / Tradisional:** Detail ikonografi, artefak kuno, dan arsitektur megah masa lalu.

---

## 📬 Mari Terhubung!
*   **GitHub:** [Profil GitHub Kamu](https://github.com/ZowweisNaN)
*   **Email:** anandak@gmail.com

🎨 *Membangun masa depan lewat baris kode dan piksel yang presisi.*
